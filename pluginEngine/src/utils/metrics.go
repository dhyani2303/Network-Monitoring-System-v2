...
var MetricsMap = map[string]string{
	...
	"system.started.time.seconds":        "Count",
	...
	"system.memory.free.percent":         "Count",
	"system.cache.memory.bytes":          "Count",
	"system.memory.used.percent":         "Count",
	"system.memory.used.bytes":           "Count",
	"system.memory.committed.bytes":      "Count",
